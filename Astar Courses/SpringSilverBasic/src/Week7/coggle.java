...
public class coggle {
    ...
    public static void main(String[] args)
    {
       ...
       Scanner sc = new Scanner(System.in);
        ...
        String calibrate = sc.nextLine();
        String[] dictionary = new String[25000];
        int currentIndex = -1;
        while (sc.hasNextLine())
        {
            currentIndex++;
            dictionary[currentIndex] = sc.nextLine();
            dictionaryLength++;
        }
    ...
    public static void findWord(String word, int index, String current, int row, int col)
    {
            ...
            else if (index > 0 && index < word.length())
            {
                ...
                if (row > 0 && col > 0) {
                    if (tempMatrix[row - 1][col - 1] == word.charAt(index))
                    {
                        ...
                        findWord(word, index + 1, current + word.charAt(index), row - 1, col - 1);
